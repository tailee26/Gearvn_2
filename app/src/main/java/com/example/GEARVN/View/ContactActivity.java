...
public class ContactActivity  extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        db.collection("ThongTinCuaHang").document("l0F0uCqzSOxPRBITcRl1")
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) { //đọc vị trí gg map
        LatLng latLng = new LatLng(21.046502824533878, 105.76220668238143); // vĩ độ trên ggmaps
        MarkerOptions options = new MarkerOptions();
        options.position(latLng);
        options.title("Hunre");
        options.snippet("Đại học Tài nguyên và Môi trường Hà Nội"); // option hiển thị thông tin vị trí lấy từ gg map

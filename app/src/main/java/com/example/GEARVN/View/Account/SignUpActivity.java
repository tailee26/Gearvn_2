package com.example.GEARVN.View.Account;
...
import com.example.GEARVN.Presenter.UserPreSenter;
import com.example.GEARVN.Presenter.UserView;
...
public class SignUpActivity extends AppCompatActivity  implements UserView , View.OnClickListener {
    ...
    @Override
    public void OnFail() {
        Toast.makeText(this, "Vui lòng nhập mật khẩu khác!", Toast.LENGTH_SHORT).show();
    }
